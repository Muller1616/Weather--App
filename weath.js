let cityInput = document.getElementById('city-input'), // Fix the typo here
    searchBtn = document.getElementById('searchBtn'),
    locationBtn = document.getElementById('locationBtn'),
    api_key = 'c9cbbe765bfeae8783eec8e0b51abe64',
        ...
        .then(data => {
            ...
            aqiCard.innerHTML = `
                ...
                <div class="air-indices">
                    <i class="fa regular fa-wind fa-3px"></i>
                    <div class="item">
                        <p>PM2.5</p>
                        <h2>${pm2_5}</h2>
                    </div>
...
.then(data =>{
    ...
    for(i=0; i<=7; i++){
        ...
        <div class="card">
            <p>${hr} ${a}</p>
            <img src="https://openweathermap.org/img/wn/${hourlyForecast[i].weather[0].icon}.png" width="50px" alt="">
        ...
        fiveDaysForecastCard.innerHTML+= `
            <div class="forecast-item">
                <div class="icon-wrapper">
                    <img src="https://openweathermap.org/img/wn/${fiveDaysForecast[i].weather[0].icon}@2x.png" alt="cloudy-sun">
